"""Autograd surface for the Mip-Splatting rasterizer provider."""
...
def rasterize_gaussians(
    ...
    return _MipWarpRasterizeGaussians.apply(
        plan,
        means3D,
        means2D,
        sh,
...
class _MipWarpRasterizeGaussians(torch.autograd.Function):
    @staticmethod
    def forward(
        ctx,
        plan,
        ...
        args = (
            ...
            raster_settings.filter_variance,
        )
