...
COVERAGE_Q_EPSILON = 1.0e-4
TILE_COVERAGE_SNUGBOX = 0
TILE_COVERAGE_ACCUTILE_SWEEP = 1
TILE_COVERAGE_CONIC_RECT = 2
TILE_COVERAGE_AUTO = 3
TILE_COVERAGE_AUTO_CONIC_RECT_MAX_TILES = 8
TILE_COVERAGE_CONIC_MASK_MAX_TILES = 64
